...
class ComentarioModel(models.Model):
    ...
    es_like = models.ForeignKey('FavoritoModel', verbose_name="Dado Like", on_delete=models.DO_NOTHING)
    es_dislike = models.ForeignKey('FavoritoModel', verbose_name="Dado Dislike", on_delete=models.DO_NOTHING)
